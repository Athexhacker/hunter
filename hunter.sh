...
clear
printf "\n"
printf "\e[1;92m     O~~     O~~O~~     O~~O~~~     O~~O~~~ O~~~~~~O~~~~~~~~O~~~~~~~      \e[0m\n"
printf "\e[1;92m     O~~     O~~O~~     O~~O~ O~~   O~~     O~~    O~~      O~~    O~~    \e[0m\n"
printf "\e[1;92m     O~~     O~~O~~     O~~O~~ O~~  O~~     O~~    O~~      O~~    O~~    \e[0m\n"
printf "\e[1;91m     O~~~~~~ O~~O~~     O~~O~~  O~~ O~~     O~~    O~~~~~~  O~ O~~        \e[0m\n"
printf "\e[1;91m     O~~     O~~O~~     O~~O~~   O~ O~~     O~~    O~~      O~~  O~~      \e[0m\n"
printf "\e[1;92m     O~~     O~~O~~     O~~O~~    O~ ~~     O~~    O~~      O~~    O~~    \e[0m\n"
printf "\e[1;92m     O~~     O~~  O~~~~~   O~~      O~~     O~~    O~~~~~~~~O~~      O~~  \e[0m\n"
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;94m Phishing Tool Created By ATHEX\e[0m\e[1;93m.:.:.\e[0m\n\n"
printf "  \e[101m\e[1;77m:: WHATSAPP NMBR: +92 3475549695 Time Passers stay away.    ::\e[0m\n"
printf "  \e[101m\e[1;77m:: YOUTUBE : @inziXploit444 ::\e[0m\n"
printf " \n"
